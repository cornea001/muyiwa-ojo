    ...
    <section id="about" className="py-28 bg-white dark:bg-navy-dark transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          {/* Floating stat card */}
          <div className="absolute -bottom-5 -right-2 bg-white dark:bg-navy border border-slate-100 dark:border-navy-light p-4 min-w-[160px] transition-colors duration-300">
            <div className=" flex text-navy/50 dark:text-cream/60 text-[10px] font-bold uppercase tracking-wider mb-1 items-center justify-center">Campaign Slogan</div>
            <div className="flex text-navy dark:text-cream font-display font-bold text-md leading-snug items-center justify-center transition-colors duration-300">
              "Listen First"
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div key={trait.label} className="flex items-center gap-3 bg-cream dark:bg-navy-light p-3 transition-colors duration-300">

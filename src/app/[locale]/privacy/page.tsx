    ...
    <main className="max-w-3xl mx-auto px-6 py-36 font-body text-navy dark:text-gray-200 transition-colors duration-300">
      ...
      <section className="space-y-8 text-[15px] leading-relaxed text-navy/80 dark:text-gray-300 transition-colors duration-300">
        ...
        <div>
          ...
          <p>{t.rich('section3_body', {
            strong: (chunks) => <strong>{chunks}</strong>,
            googleLink: (chunks) => <a href="https://policies.google.com/privacy" className="text-gold underline" target="_blank" rel="noopener noreferrer">{chunks}</a>,
            stripeLink: (chunks) => <a href="https://stripe.com/privacy" className="text-gold underline" target="_blank" rel="noopener noreferrer">{chunks}</a>
          })}</p>
        </div>
        ...
        <div>
          ...
          <p>{t.rich('section6_body', {
            emailLink: (chunks) => <a href="mailto:info@muyiwaojo.ca" className="text-gold underline">{chunks}</a>,
            phoneLink: (chunks) => <a href="tel:3435760956" className="text-gold underline">{chunks}</a>
          })}</p>
        </div>
      </section>
